...
<ToastContainer />
<div className="flex flex-col items-center justify-center min-h-screen p-20 bgLogin">
  <div className="flex flex-col w-full max-w-md overflow-hidden bg-white rounded-md shadow-lg md:flex-row md:flex-1 lg:max-w-screen-md">
    <div className="flex items-center justify-center p-4 py-6 text-white bgPrimary md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly md:w-80">
      <img src={logo.src} alt="" className="w-[185px] cursor-pointer" />
    </div>
    <div className="flex flex-col justify-center p-5 bg-white md:flex-1">
      <h3 className="mb-4 text-2xl font-semibold text-center text-gray-700">
        Account Login
      </h3>
      <form onSubmit={handleLogin} className="flex flex-col space-y-5">
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            className="w-4 h-4 rounded focus:ring-2 focus:ring-offset-0 focus:outline-none focus:ring-blue-200"
          />
        ...
        <div>
          <button
            type="submit"
            className="flex justify-center w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bgPrimary rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4"
          >
            {loading ? (
              <>
                <svg
